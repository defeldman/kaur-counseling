...
function render() {
  ...
  const backLabel = page.isService ? '← Back to Services' : '← Back home';
  const backHref = page.isService ? link('#services') : link('');
